...
const [track$1, $track] = makeTag('track');
const [u, $u] = makeTag('u');
...
export { $a, $address, $area, $article, $aside, $audio, $b, $base, $bdi, $bdo, $blockquote, $body, $br, $button, $canvas, $caption, $circle, $cite, $clipPath, $code, $col, $colgroup, $data, $datalist, $dd, $defs, $del, $desc, $details, $dfn, $dialog, $dir, $div, $dl, $dt, $ellipse, $em, $embed, $feBlend, $feColorMatrix, $feComponentTransfer, $feComposite, $feConvolveMatrix, $feDiffuseLighting, $feDisplacementMap, $feDistantLight, $feFlood, $feFuncA, $feFuncB, $feFuncG, $feFuncR, $feGaussianBlur, $feImage, $feMerge, $feMergeNode, $feMorphology, $feOffset, $fePointLight, $feSpecularLighting, $feSpotLight, $feTile, $feTurbulence, $fieldset, $figcaption, $figure, $filter, $font, $footer, $foreignObject, $form, $frame, $frameset, $g, $h1, $h2, $h3, $h4, $h5, $h6, $head, $header, $hgroup, $hr, $html, $i, $iframe, $image, $img, $input, $ins, $kbd, $label, $legend, $li, $line, $linearGradient, $link, $main, $map, $mark, $marker, $marquee, $mask, $menu, $meta, $metadata, $meter, $nav, $noscript, $object, $ol, $optgroup, $option, $output, $p, $param, $path, $pattern, $picture, $polygon, $polyline, $pre, $progress, $q, $radialGradient, $rect, $rp, $rt, $ruby, $s, $samp, $script, $section, $select, $slot, $small, $source, $span, $strong, $style, $sub, $summary, $sup, $svg, $symbol, $table, $tbody, $td, $template, $text, $textPath, $textarea, $tfoot, $th, $thead, $time, $title, $tr, $track, $tspan, $u, $ul, $use, $video, $view, $wbr, a, address, area, article, aside, audio, autoUpdate, b, base, bdi, bdo, block, blockquote, body, br, button, canvas, caption, circle, cite, clipPath, code, col, colgroup, computed, data, datalist, dd, defineComponent, defs, del, desc, details, dfn, dialog, dir, div, dl, dt, effect, ellipse, em, embed, feBlend, feColorMatrix, feComponentTransfer, feComposite, feConvolveMatrix, feDiffuseLighting, feDisplacementMap, feDistantLight, feFlood, feFuncA, feFuncB, feFuncG, feFuncR, feGaussianBlur, feImage, feMerge, feMergeNode, feMorphology, feOffset, fePointLight, feSpecularLighting, feSpotLight, feTile, feTurbulence, fieldset, figcaption, figure, filter, font, footer, foreignObject, form, frame, frameset, g, getCurrentElement, h1, h2, h3, h4, h5, h6, hComment, hShow, hSlot, hText, head, header, hgroup, hr, html, i, iframe, image, img, input, ins, isReactive, kbd, keyframes$1 as keyframes, label, legend, li, line, linearGradient, link, main, makeTag, map, mark, marker, marquee, mask, media$1 as media, menu, meta, metadata, meter, mount$1 as mount, nav, nextTick, noscript, object, ol, onElementUnmounted, onMounted, onUnmounted, onUpdated, optgroup, option, output, p, param, path, pattern, picture, polygon, polyline, pre, progress, q, radialGradient, reactive, rect, rp, rt, ruby, addCssRule as s, samp, script, section, select, slot, small, source, span, stop, strong, style, sub, summary, sup, svg, symbol, table, tbody, td, template, text, textPath, textarea, tfoot, th, thead, time, title, tr, track$1 as track, tspan, u, ul, use, video, view, wbr };
